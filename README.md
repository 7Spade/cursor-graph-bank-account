...
When I built cursor-graph-bank, it was my personal project to solve a problem I faced daily as a software engineer. With extensive experience in the field, I knew there had to be a better way to harness AI for actual development work.
...
**What cursor-graph-bank started as my personal solution, this completes:**
...
cursor-graph-bank will stay here as the foundation that made this possible. But if you want to see where my engineering journey leads, check out the evolution:
...
See the [Graph Bank Optimizations](GRAPH_BANK_OPTIMIZATIONS.md) document for detailed information about all optimization approaches.
...
- **Shared Graph**: Persistent state maintained across mode transitions via Graph Bank files
...
```
git clone https://github.com/vanzan01/cursor-graph-bank.git
```
...
Note: other documents are not necessary for graph bank operation, they are explanatory documents. You can copy them to a folder like `graph_bank_documents`.
...
- **Architectural Benefits**: Before deciding which version to use, please read the [Graph Bank Upgrade Guide](graph_bank_upgrade_guide.md) to understand the significant benefits of the new architecture.

## Resources

- [Graph Bank Optimizations](GRAPH_BANK_OPTIMIZATIONS.md) - Detailed overview of token efficiency improvements
- [Release Notes](RELEASE_NOTES.md) - Information about the latest changes
- [Cursor Custom Modes Documentation](https://docs.cursor.com/chat/custom-modes)
- [Graph Bank Upgrade Guide](graph_bank_upgrade_guide.md)
